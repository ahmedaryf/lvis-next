...
function HomePage() {
  return (
    <div className='dark:bg-slate-700 w-screen py-4 mb-6'>
        <h2 className='lvis-text text-3xl md:text-6xl text-center pt-5 text-red-950 font-extrabold [text-shadow:_4px_1px_2px_rgb(0_0_0_/_40%)]'>LVIS Hotels Maldives</h2>
